<template>
  <template v-if="type === 'table'">
    <USpace display="col" class="block" :full="true">
      <USpace display="row" pos="between">
        ...
        <USpace display="row" class="options">
  ...
  <template v-if="type === 'scroll'">
    <USpace display="col" :style="`height: ${height}`" mode="center" class="block">
      <UIcon :name="ICON_LOADING_CIRCLE" />
    </USpace>
  </template>
</template>
